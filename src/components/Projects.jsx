...
import { Github, Cpu, Database, BrainCircuit } from "lucide-react";
...
github: "https://github.com/omarglezparra",
image:
...
return ( <section id="projects" className="projects"> <h2 className="projects-title">Projects</h2>
